...
import com.ds365.erp.wms.pda.view.query.adapter.PickBatchDetailShowAdapter;
...
public class PickBillShowActivity extends BasePdaListActivity {
	...
	private TextView billCodeValue, pickerNameValue,billStateValue;
	private PullToRefreshListView listView;
	private PickBatchDetailShowAdapter adapter;
	...
	protected int getContentViewId() {
		return R.layout.query_pick_bill_show;
	}
	
	@Override
	protected void initActivityView() {
		billStateValue = (TextView) findViewById(R.id.pickBillShow_billState_value);
		...
		billStateValue.setText(bill.getBillState().getName());
		if(bill.getPicker() != null)
			pickerNameValue.setText(bill.getPicker().getName());
		adapter=new PickBatchDetailShowAdapter(context, details);
