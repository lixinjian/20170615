...
import com.ds365.erp.wms.pda.view.outwarehouse.shipmentout.activity.ShipmentGoodsDetailShowActivity;
 ...
 * 装运单明细
 */
public class ShipmentBillShowActivity extends BasePdaListActivity{
	...
	public static final String REQUEST_CODE_KEY = ShipmentBillShowActivity.class.getName();
	...
	protected void initNavigation() {
		initHeadView(R.id.shipmentOrderBillShow_headerview, R.string.shipment_bill_show);
	}
	...
	protected void initActivityView() {
		ShipmentOrderBillModel shipmentOrderBill  = (ShipmentOrderBillModel) getIntent().getSerializableExtra(
				ShipmentBillListActivity.SER_KEY);
