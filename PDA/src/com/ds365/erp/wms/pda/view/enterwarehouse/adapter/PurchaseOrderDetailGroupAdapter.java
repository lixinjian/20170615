...
public class PurchaseOrderDetailGroupAdapter extends CommonSelectAdapter<PurchaseOrderDetailModel> {
	
	public PurchaseOrderDetailGroupAdapter(Context context, List<PurchaseOrderDetailModel> list) {
		super(context, list);
	}

	@Override
	public int getContentViewId() {
		return R.layout.enterwarehouse_purchase_order_detail_group_adapter;
	}
	...
	public HolderView getHoldView(int position, View contentView, ViewGroup parent) {
		...
		holder.skuCode = (TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_skuCode_value);
		holder.unitName = (TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_unitName_value);
		holder.skuName = (TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_skuName_value);
		holder.makeSure = (TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_makesure);
		holder.makeSureImg = (ImageView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_makesureImg);
		holder.expectUnitQty =(TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_expectUnitQty_value);
		holder.expectMinUnitQty=(TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_expectMinUnitQty_value);
		holder.specQty  =(TextView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_specQty_value);
		holder.innerListView = (ListView) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_innerListView);
		holder.parent = (LinearLayout) contentView.findViewById(R.id.purchaseOrderDetailGroupAdapter_parent);
		return holder;
	}
	
	@Override
	public void setItemView(final int position, HolderView contentView, final PurchaseOrderDetailModel arg2) {
