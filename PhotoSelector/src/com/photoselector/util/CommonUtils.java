...
public class CommonUtils {
	 ...
	 * 带返回的150x150的图片裁剪
	 */
	public static void launchCropActivity(Activity context, int requestCode,String imageUrl){
	 ...
	 *限定图片个数
	 */
	public static void launchActivityForResult(Activity context, Class<?> activity, int requestCode,int maxLength) {
		Intent intent = new Intent(context, activity);
		intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
