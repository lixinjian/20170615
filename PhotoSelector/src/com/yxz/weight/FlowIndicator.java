...
public class FlowIndicator extends View {
	...
	public FlowIndicator(Context context, AttributeSet attrs) {
		...
		space = a.getDimension(R.styleable.FlowIndicator_space,12);
		radius = a.getDimension(R.styleable.FlowIndicator_point_radius,10);
		point_normal_color = a.getColor(
				R.styleable.FlowIndicator_point_normal_color,Color.parseColor("#45000000"));
		point_seleted_color = a.getColor(
				R.styleable.FlowIndicator_point_seleted_color,Color.parseColor("#ffffff"));
		a.recycle();
	}
